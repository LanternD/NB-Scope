...
U 1 1 5D90B69B
P 2775 925
F 0 "#PWR0108" H 2775 775 50  0001 C CNN
F 1 "+3.3V" H 2790 1098 50  0000 C CNN
...
U 1 1 5D90B69E
P 2575 1725
F 0 "C6" V 2675 1825 50  0000 C CNN
F 1 "10nF" V 2525 1875 50  0000 C CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 2575 1725 50  0001 C CNN
...
U 1 1 5D90B69F
P 2775 1175
F 0 "R4" H 2705 1129 50  0000 R CNN
F 1 "10k" H 2705 1220 50  0000 R CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 2705 1175 50  0001 C CNN
...
U 1 1 5D90B6A4
P 2625 2125
F 0 "J2" V 2497 2205 50  0000 L CNN
F 1 "Boot0_Jumper" V 2725 1875 50  0000 L CNN
F 2 "Connector_PinHeader_1.27mm:PinHeader_1x02_P1.27mm_Vertical" H 2625 2125 50  0001 C CNN
...
VBAT_ADC
Text Notes 2075 2475 0    50   ~ 0
Note: Put on jumper cap to\nselect ROM. Default: Flash.
...
F 2 "Inductor_SMD:L_7.3x7.3_H4.5" H 13325 1550 50  0001 C CNN
...
Wire Wire Line
	13575 1850 13575 1800
Wire Wire Line
	13475 1750 13175 1750
Wire Wire Line
...
Wire Wire Line
	13475 1550 13475 1750
$Comp
L power:+3.3V #PWR0119
U 1 1 5D920C2E
P 13825 1550
F 0 "#PWR0119" H 13825 1400 50  0001 C CNN
F 1 "+3.3V" H 13840 1723 50  0000 C CNN
F 2 "" H 13825 1550 50  0001 C CNN
F 3 "" H 13825 1550 50  0001 C CNN
	1    13825 1550
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5D920C2F
P 13575 1850
F 0 "#PWR0120" H 13575 1600 50  0001 C CNN
F 1 "GND" H 13525 1700 50  0000 R CNN
...
F 2 "Capacitor_SMD:C_1210_3225Metric" H 12325 1800 50  0001 C CNN
...
U 1 1 5D920C31
P 13575 1700
F 0 "C9" H 13667 1746 50  0000 L CNN
F 1 "10uF" H 13675 1650 50  0000 L CNN
F 2 "Capacitor_SMD:CP_Elec_4x5.4" H 13575 1700 50  0001 C CNN
F 3 "~" H 13575 1700 50  0001 C CNN
	1    13575 1700
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5D920C34
P 14950 1400
F 0 "#PWR0121" H 14950 1250 50  0001 C CNN
F 1 "+5V" H 14965 1573 50  0000 C CNN
...
U 1 1 5D92F8E0
P 8650 1725
F 0 "J6" H 8730 1717 50  0000 L CNN
F 1 "SWD_Conn" H 8450 1275 50  0000 L CNN
F 2 "Connector_PinSocket_1.27mm:PinSocket_1x06_P1.27mm_Vertical" H 8650 1725 50  0001 C CNN
...
U 1 1 5D92F8E3
P 7000 1325
F 0 "R6" V 6900 1325 50  0000 C CNN
F 1 "10k" V 7000 1325 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 6930 1325 50  0001 C CNN
...
Wire Wire Line
	6525 10225 6525 10575
Wire Wire Line
	6625 10225 6525 10225
Wire Wire Line
	8425 10625 8325 10625
NoConn ~ 4875 9125
Text Label 4475 10125 0    50   ~ 0
SDIO_DATA0
...
U 1 1 5DA39854
P 4975 8925
F 0 "#PWR0135" H 4975 8775 50  0001 C CNN
F 1 "+3.3V" H 4990 9098 50  0000 C CNN
F 2 "" H 4975 8925 50  0001 C CNN
...
U 1 1 5DA14FFE
P 7525 10025
F 0 "J3" H 7475 10742 50  0000 C CNN
F 1 "Micro_SD_Card" H 7475 10651 50  0000 C CNN
F 2 "LTD_Customized:TF_Card_Socket" H 8675 10325 50  0001 C CNN
F 3 "http://katalog.we-online.de/em/datasheet/693072010801.pdf" H 7525 10025 50  0001 C CNN
	1    7525 10025
	1    0    0    -1  
$EndComp
Text Label 8425 10625 0    50   ~ 0
TF_Card_Detection
Text Notes 5925 10975 0    50   ~ 0
Note: Pin 9 should be the shield (GND), but the footprint \nhas the card detection (CD) as Pin 9.
Text Label 4475 10025 0    50   ~ 0
SDIO_CLK
...
SDIO_CMD
Wire Wire Line
	6175 10225 6250 10225
Wire Wire Line
	6325 10125 6175 10125
Wire Wire Line
	6525 10025 6625 10025
Wire Wire Line
	6325 10325 6325 10125
Wire Wire Line
	6625 10325 6325 10325
Wire Wire Line
	6400 10025 6175 10025
$Comp
L power:GND #PWR0137
U 1 1 5DA53AB6
P 6525 10575
F 0 "#PWR0137" H 6525 10325 50  0001 C CNN
F 1 "GND" H 6575 10425 50  0000 R CNN
...
U 1 1 5DA51E3E
P 6525 9200
F 0 "#PWR0136" H 6525 9050 50  0001 C CNN
F 1 "+3.3V" H 6540 9373 50  0000 C CNN
F 2 "" H 6525 9200 50  0001 C CNN
F 3 "" H 6525 9200 50  0001 C CNN
	1    6525 9200
	1    0    0    -1  
$EndComp
NoConn ~ 6175 10325
Text Notes 8375 9000 0    50   ~ 0
TF Card Module
Wire Notes Line
	4325 11075 9325 11075
Wire Wire Line
	4975 9000 4975 9125
Connection ~ 5375 9000
Wire Notes Line
...
U 1 1 5DA50BFB
P 5975 10125
F 0 "RN2" V 5475 10000 50  0000 L CNN
F 1 "40" V 6375 10050 50  0000 L CNN
F 2 "Resistor_SMD:R_Array_Convex_8x0602" V 6450 10125 50  0001 C CNN
...
Wire Wire Line
	5175 9125 5175 9000
Wire Wire Line
	6250 10225 6250 10425
Wire Wire Line
	6250 10425 6625 10425
Wire Notes Line
	3600 8500 800  8500
Wire Wire Line
	5275 9000 5175 9000
...
Note: EEPROM address 0b1010001x. \nWhen x=0, write, x=1, read
Wire Wire Line
	7975 4750 7975 4975
Wire Wire Line
	7975 4975 7425 4975
...
F 1 "MMBT3904" H 11100 5350 50  0000 L CNN
...
U 1 1 5D7709F6
P 11025 5500
F 0 "R22" V 10925 5500 50  0000 C CNN
F 1 "2.2k" V 11025 5500 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 10955 5500 50  0001 C CNN
F 3 "~" H 11025 5500 50  0001 C CNN
	1    11025 5500
	0    1    1    0   
$EndComp
$Comp
...
Text Label 10825 5325 0    50   ~ 0
M_NET_LED
Text Label 4775 4425 0    50   ~ 0
M_SPI_CS-I2S_CS
Wire Wire Line
	10875 5500 10825 5500
Wire Wire Line
	10825 5500 10825 5325
$Comp
...
U 1 1 5E483798
P 7675 4350
F 0 "C17" V 7625 4475 50  0000 C CNN
...
F 3 "http://www.ti.com/lit/ds/symlink/txb0108.pdf" H 11050 7400 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text Notes 10100 8850 0    50   ~ 0
Note: in logic converter, VCC_A < VCC_B\nB side: 3.3 V, A side: 1.8/3.0 V
$Comp
...
Wire Wire Line
	10575 7100 10575 6725
Wire Wire Line
	10575 6725 11150 6725
Connection ~ 11150 6725
Wire Wire Line
	11150 6725 11150 6800
Wire Wire Line
	9950 7900 10650 7900
Wire Wire Line
	10650 7800 9950 7800
Wire Wire Line
	9950 7700 10650 7700
Wire Wire Line
...
Wire Wire Line
	5875 3725 5875 4325
Wire Wire Line
	4475 10125 5075 10125
Wire Wire Line
	4475 10225 4975 10225
Wire Wire Line
	4975 9525 4975 10225
Connection ~ 4975 10225
Wire Wire Line
	4975 10225 5775 10225
Wire Wire Line
	5075 9525 5075 10125
Connection ~ 5075 10125
Wire Wire Line
	5075 10125 5775 10125
Wire Wire Line
	5175 9525 5175 10025
Connection ~ 5175 10025
Wire Wire Line
	5175 10025 5775 10025
Wire Wire Line
	4475 10025 5175 10025
Wire Wire Line
	5275 9525 5275 9925
Connection ~ 5275 9925
Wire Wire Line
	5275 9925 5775 9925
Wire Wire Line
	4475 9925 5275 9925
...
F 2 "Button_Switch_SMD:SW_SPST_FSMSM" H 1775 1725 50  0001 C CNN
...
F 2 "Button_Switch_SMD:SW_SPST_FSMSM" H 5050 7700 50  0001 C CNN
...
F 2 "Button_Switch_SMD:SW_SPST_FSMSM" H 6300 7675 50  0001 C CNN
F 3 "~" H 6300 7675 50  0001 C CNN
	1    6300 7475
	1    0    0    -1  
$EndComp
$Comp
L dly_customized:Battery_Holder_2x H1
U 1 1 5D947AB4
P 10750 1325
...
$EndComp
Wire Wire Line
	14600 1300 14600 1600
$Comp
L Connector_Generic:Conn_01x03 J8
U 1 1 5D9EC1DE
P 14700 1100
F 0 "J8" V 14664 912 50  0000 R CNN
F 1 "PWR_SELECT" V 14800 1300 50  0000 R CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x03_P2.54mm_Vertical" H 14700 1100 50  0001 C CNN
...
U 1 1 5DA32137
P 5175 9325
F 0 "RN1" H 5563 9371 50  0000 L CNN
F 1 "22k" H 5563 9280 50  0000 L CNN
F 2 "Resistor_SMD:R_Array_Convex_8x0602" V 5650 9325 50  0001 C CNN
...
F 2 "LTD_Customized:SMF05C" H 2825 7900 60  0001 C CNN
...
U 1 1 5DA09042
P 6350 9425
F 0 "C20" H 6442 9471 50  0000 L CNN
F 1 "100nF" H 6442 9380 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 6350 9425 50  0001 C CNN
...
Wire Wire Line
	6525 9200 6525 9325
Connection ~ 6525 9325
Wire Wire Line
	6525 9325 6525 10025
Wire Wire Line
	6350 9525 6475 9525
Wire Wire Line
	6475 9525 6475 10225
Wire Wire Line
	6475 10225 6525 10225
Connection ~ 6525 10225
$EndSCHEMATC
