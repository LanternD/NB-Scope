...
char ssd1306_WriteString(char *str, FontDef Font, SSD1306_COLOR color) {
  ...
  while (*str) {
    if ('\n' == *str || ssd1306_WriteChar(*str, Font, color) != *str) {
...
void ssd1306_display_whole_screen(SSD1306_screen_text_t page) {
  ...
  ssd1306_WriteString(page.line1, Font_11x18, White);
  ssd1306_SetCursor(1, 20);
  ssd1306_WriteString(page.line2, Font_7x10, White);
  ssd1306_SetCursor(1, 20 + 12);
  ssd1306_WriteString(page.line3, Font_7x10, White);
  ssd1306_SetCursor(1, 20 + 12 + 12);
  ssd1306_WriteString(page.line4, Font_7x10, White);
  ssd1306_UpdateScreen();
#endif
}
